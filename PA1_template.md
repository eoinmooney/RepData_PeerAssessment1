...
**This document contains the completed work for Peer Assignment #1 for week 2 of the Coursera Reproducable Research.**
...
Read this data into a dataframe and examine the structure of the data
...
Make a histogram of the total number of steps taken each day. Before that summarize the data by day:
...
```r
#Making The Generation of This Plot Into A Function to be reused
